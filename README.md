<!--
	...
	deno run --allow-all https://raw.githubusercontent.com/jeremiah-shaulov/tsa/v0.0.57/tsa.ts doc-md --outFile=README.md --outUrl=https://raw.githubusercontent.com/jeremiah-shaulov/polysql/v2.0.19/README.md --importUrl=https://deno.land/x/polysql@v2.0.19/mod.ts mod.ts
-->
...
```ts
import {mysqlQuote as sqlQuote} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
import {mysql as sql} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
import {mysqlOnly as sql} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
```ts
import {mysql as sql, Sql} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
import {mysql as sql, SqlSettings, SqlMode} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
import {SqlSettings, SqlMode} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
import {Sql, SqlSettings, SqlMode, SqlTable} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
...
import {SqlSettings, SqlMode, SqlTable} from 'https://deno.land/x/polysql@v2.0.19/mod.ts';
