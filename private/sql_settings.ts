...
const DEFAULT_IDENTS_POLICY = `NOT AND OR XOR BETWEEN SEPARATOR IS NULL DISTINCT LIKE CHAR JSON IN BOOLEAN MODE INTERVAL YEAR MONTH WEEK DAY HOUR MINUTE SECOND MICROSECOND CASE WHEN THEN ELSE END AS ORDER BY ASC DESC`;
